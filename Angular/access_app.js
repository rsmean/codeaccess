...
corsaApp.run(['$rootScope', '$state', '$localStorage', '$AuthService', '$SessionService','SITE_CONSTANTS','$anchorScroll','$anchorScroll','$templateCache', function($rootScope, $state, $localStorage, $AuthService, $SessionService, SITE_CONSTANTS, $anchorScroll, $templateCache) {
          ...
          //$templateCache.put('FlashMessage.html', '/elements/notifyMessages.html');
          //$templateCache.put('sam', "hello");
...
corsaApp.config(["$httpProvider","$stateProvider","$urlRouterProvider","$locationProvider","$authProvider","AccessLevels", function($httpProvider, $stateProvider, $urlRouterProvider, $locationProvider, $authProvider, AccessLevels) {
    ...
    $httpProvider.defaults.headers.get['Pragma'] = 'no-cache';
     ...
     .state('anon.support-mobile', {
          url: '/support-mobile',
          templateUrl: '/templates/front/support-mobile.html'

     })
     .state('anon.how-corsa-mobile', {
          url: '/how-corsa-mobile',
          templateUrl: '/templates/front/how-corsa-mobile.html'

     })
     .state('anon.faq-mobile', {
          url: '/faq-mobile',
          templateUrl: '/templates/front/faq-mobile.html',
          controller: 'HomeController'

     })
     .state('anon.terms-mobile', {
          url: '/terms-mobile',
          templateUrl: '/templates/front/term-mobile.html'
...
corsaApp.factory('SocketService', ['$rootScope', require('./services/SocketService.js')]);
...
corsaApp.directive('schrollBottom', ['$parse', require('./directives/scrollBottom.js')]);

corsaApp.controller('AccountController', ['$stateParams','$timeout','$scope', '$state', '$AuthService', '$SessionService', '$localStorage','$AccountService','$auth','VehicleService', 'FlashService','SocketService','$uibModal', require('./controllers/AccountController.js')]);
corsaApp.controller('AuthController', ['$LocalService','$scope','$rootScope', '$state', '$stateParams', '$AuthService', '$RememberService', '$localStorage','$auth','$timeout','FlashService','SocketService', require('./controllers/AuthController.js')]);
...
corsaApp.controller('VehicleController', ['$timeout','$scope', '$rootScope','$stateParams', '$state', '$localStorage', '$location', '$http','VehicleService','$SessionService','$AccountService', '$uibModal', '$log','NgTableParams','FlashService', require('./controllers/VehicleController.js')]);
...
corsaApp.controller('SupportController', ['$LocalService','$scope', '$rootScope', '$state', '$AuthService', '$SessionService', '$location', '$localStorage','$AccountService','$timeout','$filter','SocketService', require('./controllers/SupportController.js')]);
corsaApp.controller('MessageController', ['$stateParams','$timeout','$scope', '$state', '$AuthService', '$SessionService', '$localStorage','$AccountService','$auth','VehicleService', 'FlashService', require('./controllers/MessageController.js')]);
